...
export const ReceivedFriendRequests = ({
  ...
  if (friendRequests.length === 0) return <NoDataPlaceholder message="No invitations received" nameSpace="myFriends" />;
...
const RequestsWrapper = <T extends ReceivedFriendRequest | SentFriendRequest>({
  friendRequests,
  children,
