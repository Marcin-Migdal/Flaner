...
export function GroupCard({ group }: GroupCardProps) {
  ...
  return (
    <button
      ...
      className="relative flex flex-col p-5 bg-card text-card-foreground border border-border hover:border-brand/40 shadow-sm hover:shadow-md transition-all duration-300 rounded-2xl cursor-pointer group-card-hover overflow-hidden text-left w-full"
    >
