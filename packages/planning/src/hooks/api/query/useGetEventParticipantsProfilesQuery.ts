...
import { getEventParticipantsProfiles, type ParticipantResult } from "../../../api/participants";

export const getEventParticipantsProfilesQueryKeys = (userIds: string[]) => ["participants", "profiles", userIds.sort().join(",")];

export const useGetEventParticipantsProfilesQuery = <TData = ParticipantResult[]>(
  userIds: string[],
...
export default useGetEventParticipantsProfilesQuery;
